...
def load_images(card_images):  # loading the card images
...
def score_hand(hand):
    ...
    only 1 ace can have a value of 11
    and this will be reduced to 1 id the hand would bust"""
    score = 0
    ace = False
...
replay_button = tkinter.Button(button_frame, text='Replay', command=replay)
replay_button.grid(row=0, column=2)
quit_button = tkinter.Button(button_frame, text='Quit', command=mainWindow.quit)
